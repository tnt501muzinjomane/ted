...
class PartnershipsControllerTest < ActionController::TestCase
  ...
  test "should create partnership" do
    assert_difference('Partnership.count') do
      post :create, partnership: { citizen: @partnership.citizen, nump: @partnership.nump, partnership: @partnership.partnership, rdate: @partnership.rdate, user_id: @partnership.user_id, visitor_id: @partnership.visitor_id }
    end
  ...
  test "should update partnership" do
    patch :update, id: @partnership, partnership: { citizen: @partnership.citizen, nump: @partnership.nump, partnership: @partnership.partnership, rdate: @partnership.rdate, user_id: @partnership.user_id, visitor_id: @partnership.visitor_id }
    assert_redirected_to partnership_path(assigns(:partnership))
  end
