...
class ReasonsControllerTest < ActionController::TestCase
  ...
  test "should create reason" do
    assert_difference('Reason.count') do
      post :create, reason: { citizen: @reason.citizen, nump: @reason.nump, reason: @reason.reason, user_id: @reason.user_id }
    end
  ...
  test "should update reason" do
    patch :update, id: @reason, reason: { citizen: @reason.citizen, nump: @reason.nump, reason: @reason.reason, user_id: @reason.user_id }
    assert_redirected_to reason_path(assigns(:reason))
  end
